...
const SavedMovies = () => {
  ...
  return (
    ...
    <div className=' absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white'>
      <p className=' white-space-normal text-xs md:sm font-bold flex justify-center items-center h-full text-center'>
        {item?.title}{item?.original_name}
      </p>
      <p onClick={()=> deleteMovie(item.id)} className=' absolute text-gray-200 top-4 right-4'>
      <AiOutlineClose />
      </p>
    </div>
</div>
